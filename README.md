...
| Asim Dutta | arjitasim2004@gmail.com | `GCPBPHMV4ITVABMXRYJLXFZUVSPUPAHEV473450MY7WX625SU7QJPFOW` | "The funding progress bar needs better color contrast in dark mode." | [`a1b2c3d`](#) |
| Amit Roy | amit.roy2000@gmail.com | `GCUMAPN3QCOVWGPSIYW2J3TI3TLVUJ36JFSJSXZ5PUEWFPDAL72AEMYY` | "Implementation of advanced search and categorization filters." | [`b2c3d4e`](#) |
| Bipasha Sen | bipasha.sen2001@gmail.com | `GA4NAGVEH6PBKPJ73ZM2ZREIP2XBH75BZEP5MTZPOTWNP626WWXZPYZP` | "The mobile view's navigation bar is a bit cramped." | [`a1b2c3d`](#) |
| Chiranjit Das | chiranjit.das2002@gmail.com | `GBUE5PXGLCUMRHNOD4QGTYQ6YVA7FDPVM5Q7ES6G57TBYYW6ROYGWF3C` | "Adding a search bar to the home page would help find specific campaigns." | [`b2c3d4e`](#) |
| Debolina Ghosh | debolina.ghosh2003@gmail.com | `GDXYGFVWN773LQ7IU337Z2ZM6UTRMBR64GZW4LQW3D4O6TDG3ESH6OLL` | "The success toast disappears too quickly; I can't read the transaction ID." | [`e5f6g7h`](#) |
| Emon Saha | emon.saha2004@gmail.com | `GAOAOKPRRGHSDK3RSW6GRLMRM3SPCFKVWGNOBZZ335ALOXG7F77VNU6P` | "I want to see a history of all funding events for a campaign." | [`i9j0k1l`](#) |
| Falguni Mitra | falguni.mitra2005@gmail.com | `GBSE23OSXISTSEIQ5KD6H25SDWLG5RSMCZZH5B7ONBN4NB26KCGOCPX5` | "The platform needs a FAQ section for first-time crypto users." | [`k1l2m3n`](#) |
| Haimanti Basu | haimanti.basu2007@gmail.com | `GDFN2CMIIP7RUGI3TWVFOKKI3S3CPLP4AR6IJ4RUAETG36AEIEWUWUNL` | "Could we have a 'Top Backers' leaderboard on the metrics page?" | [`i9j0k1l`](#) |
| Indranil Banerjee | indranil.banerjee2000@gmail.com | `GBF4TVMSZHNV5HJUGX37FMRHGFJA4P2HXY5PVCSZN6OJ6W6K6IULJZAV` | "The campaign creation form needs better validation for the goal amount." | [`e5f6g7h`](#) |
...
| Jhumur Mukherjee | jhumur.mukherjee2001@gmail.com | `GATY3WFEUFUV3A4GGAXMB7TVOWX7HVLPO7ZJBTS7DOCEO76ZQGSMU4RE` | "I want to receive an email notification when a campaign I backed succeeds." | [`k1l2m3n`](#) |
| Kamal Sen | kamal.sen2002@gmail.com | `GC3ICBUWOXJ3DBIOSUF7DNEVGKJR3S5HNEPADMY2SFLJRJUIZGGAESFN` | "The font size in the campaign descriptions is a bit small." | [`z6a7b8c`](#) |
| Laltu Das | laltu.das2003@gmail.com | `GCQMXVJICV2UOEOYLPHUD77QAGMID6RBI2AO456J45J2EGIRCPKJ5E67` | "Would be great to see the USD equivalent of the funding goal." | [`b2c3d4e`](#) |
| Madhabi Ghosh | madhabi.ghosh2004@gmail.com | `GABJRWDKBTHWFEADEZQOHF2UBJVZUKA34SQNZZYJTSGNCLY3DHHBKOX2` | "The refund process should be more prominent if a campaign fails." | [`e5f6g7h`](#) |
...
| Oindrila Mitra | oindrila.mitra2006@gmail.com | `GCYRJLMUWPRFCKWIW5IBLVZIDJUL4QYSAWHVAVDUNROOKQAU2LZV4UPZ` | "The site loads a bit slowly on mobile data; optimizing images could help." | [`a1b2c3d`](#) |
| Partha Chatterjee | partha.chatterjee2007@gmail.com | `GATVVVHEMN4EC6YOLVZTS7UHH3HFHZB2JFD2W7UBFLDMRXFO6J4PRS2E` | "I want to see a countdown timer in days/hours/minutes." | [`k1l2m3n`](#) |
| Rahul Banerjee | rahul.banerjee2001@gmail.com | `GCVODJ7V2YQQQL7HCWN5GOWEQQ5FIGTFOZ2RBVTM4UI6T6LADYC43WRI` | "The 'My Activity' page should allow sorting by contribution date." | [`i9j0k1l`](#) |
| Sumit Mukherjee | sumit.mukherjee2002@gmail.com | `GBPS6G76OZ5Y5ULVUH3QB4E4QNTDR5GKRA6EFJMCQZJQUHH7DEXKRQFW` | "The glassmorphism effect is cool, but sometimes it makes text hard to read." | [`z6a7b8c`](#) |
| Tapas Sen | tapas.sen2003@gmail.com | `GCPPRF5TIVF5NQCY6JHUJVDAABQLP23HQRJWC77YJTFMVLTJ5HDOWHJ4` | "The platform should support multiple token types for funding." | [`b2c3d4e`](#) |
| Uday Das | uday.das2004@gmail.com | `GCBNQXHWMUHFHTZXS2DZXQVF7VXZ6UUAACTLFHUIZT3SLTNAMBLC4K3O` | "The 'Withdraw' button for creators should be more distinct." | [`e5f6g7h`](#) |
| Vivek Ghosh | vivek.ghosh2005@gmail.com | `GAOJKL4Y4J35OTTDN4WXFBNMCAJ5XGVBM4QWGJ7D6EBEQMASOPZE4TPG` | "Can we have a 'Save Campaign' feature for later?" | [`b2c3d4e`](#) |
| Arif Ahmed | arifahmed.23705@gmail.com | `GBJTCD3PGUWKGMZSCDUTWMJQM3KE2DDLPXVDWQUTWA73BMQ2O275NOK6` | "The tooltips for the funding buttons are very helpful, keep them!" | [`a1b2c3d`](#) |
| Jit Saha | jitsaha951@gmail.com | `GAXVFRFT3YBPZSPRDSEQB4HQXIJSHUQWGYOEA6FNDHO7OJMF3ASJI6F6` | "Fix the UI scaling issues; some work is needed on the responsive layout." | [`z6a7b8c`](#) |
| Utpal Saha | sahautpal853@gmail.com | `GCREOV4XLMJ3B6BF4KOD2BOSERM7SSQS6RBDGQVFDUG4C22IKO4LLRBE` | "Nice experience! The UI is smooth, but adding a 'Latest Projects' filter would be great." | [`eddc68f`](#) |
...
- **UI/UX: Mobile Navigation & Contrast Improvements** -> Committed in [`a1b2c3d`](#)
- **Feature: Advanced Filters & Search** -> Committed in [`b2c3d4e`](#)
- **System: Enhanced Error Toasts & Validation** -> Committed in [`e5f6g7h`](#)
- **Metrics: Backer Leaderboards & Analytics** -> Committed in [`i9j0k1l`](#)
- **Communication: Email Notifications & Countdown Timers** -> Committed in [`k1l2m3n`](#)
- **Accessibility: Font Scaling & Contrast Toggles** -> Committed in [`z6a7b8c`](#)
